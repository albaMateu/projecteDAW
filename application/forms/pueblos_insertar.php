<?php
    ...
    $pueblo_obj = new pueblo();
    if(isset($_GET['action'])) {
        $action = $_GET['action'];
        $id=$_REQUEST['id']; //de la URL
        if($action=='editar'){
           $pueblo_obj = $m_p->getPueblo($id);
        }
    }
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="row">
                                      <?php
                                        if($action == "editar"){
                                            echo ' <h3 class="title1">Editar pueblo </h3>';
                                        }else{
                                            echo ' <h3 class="title1">Insertar nuevo pueblo </h3>';
                                        }
                                    ?>
                                    <div class="form-three widget-shadow">
                                                     <?php
                                                        if($action == "editar"){
                                                    ?> 
                                            <form class="form-horizontal" action="../controllers/pueblos_controller.php?action=actualizar" method="post">
                                                    <div class="form-group">
                                                            <div class="col-sm-8">
                                                                <input type="hidden" class="form-control1" name="cp" id="nombre" value="<?php echo $pueblo_obj->getCodigo_postal(); ?>" placeholder="Código Postal">
                                                            </div>
                                                     </div>
                                                     <?php
                                                        }else{
                                                      ?>
                                            <form class="form-horizontal" action="../controllers/pueblos_controller.php?action=insertar" method="post">
                                                      <div class="form-group">
                                                        <label for="focusedinput" class="col-sm-2 control-label">Código Postal*</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" pattern="0[1-9][0-9]{3}|[1-4][0-9]{4}|5[0-2][0-9]{3}" class="form-control1" name="cp" id="nombre" value="<?php echo $pueblo_obj->getCodigo_postal(); ?>" placeholder="Código Postal" required>
                                                                <?php
                                                                    if($_GET['error']==2){
                                                                        echo '<p> Necesarios 5 dígitos</p>';
                                                                    }
                                                                ?>
                                                            </div>
                                                     </div>
                                                     ...
                                                     ?>
                                                    <div class="form-group">
                                                            <label for="focusedinput" class="col-sm-2 control-label">Población*</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control1" name="poblacion" id="nombre" value="<?php echo $pueblo_obj->getPoblacion(); ?>" placeholder="Población" required>
                                                                <?php
                                                                if(isset($_GET['error'])){
                                                                    if($_GET['error'] == 1){
                                                     ...
                                                     <div class="form-group">
                                                            <label for="focusedinput" class="col-sm-2 control-label">Província</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control1" name="provincia" id="nombre" value="<?php echo $pueblo_obj->getProvincia(); ?>" placeholder="Província">
                                                            </div>
                                                     </div>
