					...
					<ul class="nav" id="side-menu">
                                            <li>
                                                  <?php 
                                                     ...
                                                     switch($idRol){
                                                        case 1:
                                                            echo '<a href="administrador_inicio.php?rol=1">Inicio</a>';
                                                            break;
                                                        case 2:
                                                            echo '<a href="administrador_inicio.php?rol=2">Inicio</a>';
                                                            break;
                                                        case 3:
                                     ...
                                     <?php 
                                        ...
                                        switch($idRol){
                                           case 1:
                                               ...
                                               echo '<a href="administrador_inicio.php?rol=1" style="padding: 0.9em 2.15em .7em;">';
                                               break;
                                           case 2:
                                               echo '<a href="administrador_inicio.php?rol=2" style="padding: 0.9em 2.15em .7em;">';
                                               break;
                                           case 3:
                                                    ...
                                                    <tbody> 
                                                        <?php
                                                            foreach ($total as $trab) {
                                                                echo '<tr>
                                                                        <th scope="row">'.$trab->getNombre().'</th>
                                                                        <td>'.$trab->getTelefono().'</td>
                                                                        <td>'.$trab->getEmail().'</td>
                                                                        <td><a href="trabajadores.php?act=1&us='.$trab->getUsuario().'">Mostrar</a></td>
                                                                      </tr>';
                                                             }
                                                        ?>
                                                    </tbody> 
