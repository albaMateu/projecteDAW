					...
					<div class="table-responsive bs-example widget-shadow">
						<!--<h4>Responsive Table:</h4>-->
                                                <?php 
                                                    ...
                                                    if($action == 'ver'){
                                                         $sql= "SELECT * FROM Trabajadores WHERE usuario='".$_GET['user']."'";
                                                    }else{
                                                        $sql= "SELECT * FROM Trabajadores WHERE usuario='".$_SESSION['usuario']."'";
                                                    }
                                                        ...
                                                        <?php
                                                            foreach ($total as $trab) {
                                                                echo '<tr>
                                                                      ...
                                                                      <tr>
                                                                        <th>Población</th>
                                                                        <td>'.$m_p->getPoblacion($trab->getCp()).'</td>
                                                                      </tr>
                                                                      <tr>
                                                                        <th>Teléfono</th>
                                                                      ...
                                                                      <tr>
                                                                        <th>Contrato</th>
                                                                        <td>'.$trab->getContrato().'</td>
                                                                      </tr>
                                                                      <tr>
                                                                        <th>Responsable de zona</th>
                                                                        <td>'.$trab->getSuperior().'</td>
                                                                      </tr>';
                                                             }
                                                        ?>
                                                    </tbody> 
