<?php
    ...
    $idRol=$roles->getId();
    /*----------------------------------------------------*/
    include '../models/pueblos_model.php';
    include '../entidades/pueblo.php';
    $m_pueb=new pueblos_model();
?>
<!DOCTYPE HTML>
<html>
<head>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Pueblos</h3>
                                         <a href="../forms/pueblos_insertar.php"><button class="button" class="btn btn-default" type="button"><img class="insert" id="accions" src="../assets/img/afegir.png" title="insertar" alt="insertar"/> Insertar nuevo</button> </a>
					...
					<div class="table-responsive bs-example widget-shadow">
						<!--<h4>Responsive Table:</h4>-->
                                                <?php 
                                                    ...
                                                    $sql= "SELECT * FROM Pueblos WHERE poblacion <> ' ' ORDER BY provincia, poblacion";
                                                    //$sql= "SELECT * FROM Pueblos ORDER BY provincia, poblacion";
                                                    $total=$m_pueb->listar($sql);
                                                ?>
						<table class="table table-bordered"> 
                                                    ...
                                                    <tbody> 
                                                        <?php
                                                            foreach ($total as $pueb) {
                                                                echo '<tr>
                                                                        <td><a href="../forms/pueblos_insertar.php?action=editar&id='.$pueb->getCodigo_postal() .'"><img id="accions" src="../assets/img/editar.png" title="editar" alt="editar"/></a></td>
                                                                        <td><a href="../controllers/pueblos_controller.php?action=eliminar&id='.$pueb->getCodigo_postal() .'"><img id="accions" src="../assets/img/borrar.png" title="eliminar" alt="eliminar"/></a></td>
                                                                        <th scope="row">'.$pueb->getCodigo_postal().'</th>
                                                                        <td>'.$pueb->getPoblacion().'</td>
                                                                        <td>'.$pueb->getProvincia().'</td>
                                                                      </tr>';
                                                             }
                                                        ?>
                                                    </tbody> 
